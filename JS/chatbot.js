(function () {
  ...
  var knowledge = [
    ...
    },
    {
      ...
      followups: ['horarios', 'voluntariado']
    },
    {
      id: 'emergencia',
      label: 'Emergencia',
      ...
      followups: ['contacto', 'voluntariado'],
      emergency: true
    },
    {
      id: 'maltrato',
    ...
    },
    {
      ...
      followups: ['adopcion', 'voluntariado']
    },
    {
      id: 'saludo',
      label: 'Saludo',
      ...
      followups: ['adopcion', 'horarios', 'voluntariado']
    },
    {
      id: 'despedida',
      label: 'Despedida',
  ...
  var defaultResponse = {
    ...
    followups: ['adopcion', 'horarios', 'contacto']
  };
  ...
  function getWelcomeMessage() {
    ...
    var base = {
      ...
      contacto: {
        response: '¡Hola' + name + '! 💌 ¿Necesitas contactarnos? Puedo ayudarte con información sobre horarios o resolver tus dudas directamente.',
        followups: ['horarios', 'contacto', 'voluntariado']
      },
      inicio: {
    ...
    function resetIdleTimer() {
      ...
      state.idleTimer = setTimeout(function () {
        if (state.isOpen && state.history.length > 0) {
          ...
          addBotMessage(pick, ['adopcion', 'horarios', 'voluntariado'], { actions: [] });
        }
      }, 45000);
    }
